(function () {
  ...
  if (getFormSticky()) {
    const closeButton = document.querySelector(
      ".ee-sticky-contact-form__close-button",
    );
    if (closeButton)
    ...
    [...document.querySelectorAll(".ee-form-control").values()].forEach(
      (el) => {
  ...
  [...document.querySelectorAll("form.ee-contact-form").values()].forEach(
    (form) => {
      ...
      const updateForm = () => {
        ...
        [...form.querySelectorAll(".ee-contact-form-type")].forEach((tile) =>
        ...
        const tile = form.querySelector(
          `*[for="id_subject__${subjectField.value}"] .ee-contact-form-type`,
        );
        if (tile) {
          ...
          form
            .querySelector(".ee-contact-form__fields-container")
